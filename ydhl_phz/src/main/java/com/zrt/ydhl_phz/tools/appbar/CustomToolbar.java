...
public class CustomToolbar extends Toolbar {
    ...
    CustomToolbar.OnMenuItemClickListener mOnMenuItemClickListener;
...
//    private ActionMenuPresenter mOuterActionMenuPresenter;
    private CustomToolbar.ExpandedActionViewMenuPresenter mExpandedMenuPresenter;
...
//            oldMenu.removeMenuPresenter(mOuterActionMenuPresenter);
        ...
        if (mExpandedMenuPresenter == null) {
            mExpandedMenuPresenter = new CustomToolbar.ExpandedActionViewMenuPresenter();
        }
...
//        mOuterActionMenuPresenter = outerPresenter;
    ...
    public boolean isTitleTruncated() {
        ...
        View titleView = mTitleTextView.findViewById(R.id.titleView);
        TextView title = titleView.findViewById(R.id.toolbar_title);
        if (title == null) {
            return false;
        }

        final Layout titleLayout = title.getLayout();
        if (titleLayout == null) {
            return false;
        }
    ...
    /**
     * Returns the title of this CustomToolbar.
     *
...
//    /**
//     * Set the title of this CustomToolbar.
//     *
...
//    }
    ...
    public void setTitle(View titleView) {
        this.setTitle(titleView, null);
    }
    public void setTitle(View titleView, TextView titleText) {
        if (titleView != null) {
            if (mTitleTextView == null) {
    ...
    /**
     * Return the subtitle of this CustomToolbar.
     *
    ...
    /**
     * Set the subtitle of this CustomToolbar.
     *
...
//            mTitleTextView.setTextColor(color);
     ...
     * at the start of the CustomToolbar. An icon must be set for the navigation button to appear.</p>
     *
    ...
    /**
     * Return the Menu shown in the CustomToolbar.
     *
    ...
    private void ensureMenuView() {
        if (mMenuView == null) {
            ...
            final CustomToolbar.LayoutParams lp = generateDefaultLayoutParams();
    ...
    /**
     * Inflate a menu resource into this CustomToolbar.
     *
     * <p>Inflate an XML menu resource into this CustomToolbar. Existing items in the menu will not
     ...
     * @param listener Listener to set
     */
    public void setOnMenuItemClickListener(CustomToolbar.OnMenuItemClickListener listener) {
    ...
    /**
     * Gets the starting content inset for this CustomToolbar.
     *
     * <p>The content inset affects the valid area for Toolbar content other than
     * the navigation button and menu. Insets define the minimum margin for these components
     * and can be used to effectively align Toolbar content along well-known gridlines.</p>
    ...
    /**
     * Gets the ending content inset for this CustomToolbar.
     *
     * <p>The content inset affects the valid area for Toolbar content other than
     * the navigation button and menu. Insets define the minimum margin for these components
     * and can be used to effectively align Toolbar content along well-known gridlines.</p>
    ...
    /**
     * Sets the content insets for this CustomToolbar.
     *
     * <p>The content inset affects the valid area for Toolbar content other than
     * the navigation button and menu. Insets define the minimum margin for these components
     * and can be used to effectively align Toolbar content along well-known gridlines.</p>
    ...
    /**
     * Gets the left content inset for this CustomToolbar.
     *
     * <p>The content inset affects the valid area for Toolbar content other than
     * the navigation button and menu. Insets define the minimum margin for these components
     * and can be used to effectively align Toolbar content along well-known gridlines.</p>
    ...
    /**
     * Gets the right content inset for this CustomToolbar.
     *
     * <p>The content inset affects the valid area for Toolbar content other than
     * the navigation button and menu. Insets define the minimum margin for these components
     * and can be used to effectively align Toolbar content along well-known gridlines.</p>
    ...
    void ensureCollapseButtonView() {
        if (mCollapseButtonView == null) {
            ...
            final CustomToolbar.LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (mButtonGravity & Gravity.VERTICAL_GRAVITY_MASK);
            lp.mViewType = CustomToolbar.LayoutParams.EXPANDED;
    ...
    private void addSystemView(View v, boolean allowHide) {
        ...
        final CustomToolbar.LayoutParams lp;
        if (vlp == null) {
            lp = generateDefaultLayoutParams();
        } else if (!checkLayoutParams(vlp)) {
            lp = generateLayoutParams(vlp);
        } else {
            lp = (CustomToolbar.LayoutParams) vlp;
        }
        lp.mViewType = CustomToolbar.LayoutParams.SYSTEM;
    ...
    protected Parcelable onSaveInstanceState() {
        CustomToolbar.SavedState state = new CustomToolbar.SavedState(super.onSaveInstanceState());
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof CustomToolbar.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        final CustomToolbar.SavedState ss = (CustomToolbar.SavedState) state;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            final View child = getChildAt(i);
            final CustomToolbar.LayoutParams lp = (CustomToolbar.LayoutParams) child.getLayoutParams();
            if (lp.mViewType != CustomToolbar.LayoutParams.CUSTOM || !shouldLayout(child)) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int titleHeight = 0;
        if (layoutTitle) {
            final CustomToolbar.LayoutParams lp = (CustomToolbar.LayoutParams) mTitleTextView.getLayoutParams();
            titleHeight += lp.topMargin + mTitleTextView.getMeasuredHeight() + lp.bottomMargin;
        }
        if (layoutSubtitle) {
            final CustomToolbar.LayoutParams lp = (CustomToolbar.LayoutParams) mSubtitleTextView.getLayoutParams();
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            final CustomToolbar.LayoutParams toplp = (CustomToolbar.LayoutParams) topChild.getLayoutParams();
            final CustomToolbar.LayoutParams bottomlp = (CustomToolbar.LayoutParams) bottomChild.getLayoutParams();
    ...
    private int getViewListMeasuredWidth(List<View> views, int[] collapsingMargins) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            final CustomToolbar.LayoutParams lp = (CustomToolbar.LayoutParams) v.getLayoutParams();
    ...
    @Override
    public CustomToolbar.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new CustomToolbar.LayoutParams(getContext(), attrs);
    }

    @Override
    protected CustomToolbar.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        if (p instanceof CustomToolbar.LayoutParams) {
            return new CustomToolbar.LayoutParams((CustomToolbar.LayoutParams) p);
        } else if (p instanceof ActionBar.LayoutParams) {
            return new CustomToolbar.LayoutParams((ActionBar.LayoutParams) p);
        } else if (p instanceof ViewGroup.MarginLayoutParams) {
            return new CustomToolbar.LayoutParams((ViewGroup.MarginLayoutParams) p);
        } else {
            return new CustomToolbar.LayoutParams(p);
        }
    }

    @Override
    protected CustomToolbar.LayoutParams generateDefaultLayoutParams() {
        return new CustomToolbar.LayoutParams(CustomToolbar.LayoutParams.WRAP_CONTENT, CustomToolbar.LayoutParams.WRAP_CONTENT);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return super.checkLayoutParams(p) && p instanceof CustomToolbar.LayoutParams;
    }

    private static boolean isCustomView(View child) {
        return ((CustomToolbar.LayoutParams) child.getLayoutParams()).mViewType == CustomToolbar.LayoutParams.CUSTOM;
    }
    ...
    void removeChildrenForExpandedActionView() {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            final View child = getChildAt(i);
            final CustomToolbar.LayoutParams lp = (CustomToolbar.LayoutParams) child.getLayoutParams();
            if (lp.mViewType != CustomToolbar.LayoutParams.EXPANDED && child != mMenuView) {
                removeViewAt(i);
...
//    }
     ...
     *
     * <p>CustomToolbar.LayoutParams extends ActionBar.LayoutParams for compatibility with existing
     * ActionBar API. See
    ...
    public static class LayoutParams extends Toolbar.LayoutParams {
        ...
        public LayoutParams(CustomToolbar.LayoutParams source) {
            super(source);
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public static final Creator<CustomToolbar.SavedState> CREATOR = new ClassLoaderCreator<CustomToolbar.SavedState>() {
            @Override
            public CustomToolbar.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                return new CustomToolbar.SavedState(in, loader);
            }

            @Override
            public CustomToolbar.SavedState createFromParcel(Parcel in) {
                return new CustomToolbar.SavedState(in, null);
            }

            @Override
            public CustomToolbar.SavedState[] newArray(int size) {
                return new CustomToolbar.SavedState[size];
            }
        };
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (collapseButtonParent != CustomToolbar.this) {
            ...
            if (expandedActionParent != CustomToolbar.this) {
