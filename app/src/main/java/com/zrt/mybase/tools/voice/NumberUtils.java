...
public class NumberUtils {
	 ...
	 * @return
	 */
	public static String numberCN2Arab(String numberCN) {

		String tempNumberCN = numberCN;

		// 异常数据处理;
		if (TextUtils.isEmpty(tempNumberCN)) {
			return numberCN;
		}
		
		if(!TextUtils.isEmpty(numberCN.replaceAll("[零一二三四五六七八九十百千万亿]", ""))){
			return numberCN;
		}
		...
		return String.valueOf(Integer.parseInt(tempResultNum));
	}
